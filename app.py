...
user_name = "hm168443938724"
api_key = "VZXgPlzZttoL3r4HBhVlGW2q6"
api_secret = "f8OfFmjKHrUoT5kLiX64y8wcVQKb9WTveJ3GQqTKhZWfZjhCCc"
bearer_token = "AAAAAAAAAAAAAAAAAAAAAHbrpwEAAAAATldRBuoLMyjuQgVtl%2BJHwXH%2B7t8%3Dhh5WFzhlmtpMCj4V5gSIiVL8X79BYldkv9DrbTWcnu9oNwDvsd"
access_token = "1702907001989459968-iKG4skM5uePsRXSe0jpLTv5ODbQnRw"
access_token_secret = "o9EblqqsTgQOLjyTArylTQm4FKtQmZMQJHIpIiILP2jgz"
...
def delete_tweet_fn(id:str):
    ...
    if response.status_code == 400:
        return {"error":"tweetID not found"}
    elif response.status_code == 200:
        return {"success":"tweet deleted"}
    return response.json()
